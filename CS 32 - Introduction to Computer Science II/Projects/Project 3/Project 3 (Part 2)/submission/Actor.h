...
class Actor : public GraphObject {
	public:
		...
		virtual void doSomething() = 0;									// virtual function that does nothing by default
...
class Socrates : public Actor {
	...
	private:
		...
		int getPositionalAngle() const;		// returns positional angle of Socrates; auxiliary function for doSomething()	
...
class DirtPile : public Actor {
	public:
		...
		DirtPile(double startX, double startY, StudentWorld* world)
			: Actor(IID_DIRT, startX, startY, world, 0, 1) {}
		virtual void doSomething() {}	// dirt piles do nothing
};
...
class Food : public Actor {
	public:
		...
		virtual void doSomething() {};	// food objects do nothing
};
...
class Projectile : public Actor {
	public:
		// constructor
		Projectile(int imageID, double startX, double startY, Direction dir, StudentWorld* world, int travelableDist)
			: Actor(imageID, startX, startY, world, dir, 1), m_travelableDist(travelableDist) {}
		// mutators
		virtual void doSomething();
...
class Flame : public Projectile {
	public:
		...
		Flame(double startX, double startY, Direction dir, StudentWorld* world)
			: Projectile(IID_FLAME, startX, startY, dir, world, MAX_FLAME_TRAVELABLE_DIST) {}
		virtual int getDamage() const { return FLAME_DAMAGE; }
};
...
class Spray : public Projectile {
	public:
		...
		Spray(double startX, double startY, Direction dir, StudentWorld* world)
			: Projectile(IID_SPRAY, startX, startY, dir, world, MAX_SPRAY_TRAVELABLE_DIST) {}
		virtual int getDamage() const { return SPRAY_DAMAGE; }
};
...
class Fungus : public Goodie {
	public:
		...
		virtual void updateSocrates() const;		// damage socrates
...
class Bacterium : public Actor {
	public:
		...
		virtual void createNewBacterium(double x, double y) const = 0;	// instructs StudentWorld to create a new Bacterium of the appropriate class
			// const because it doesn't actually change the bacterium itself
