...
DeliveryResult PointToPointRouterImpl::generatePointToPointRoute(
    ...
    // DEBUGGING
    // cerr << "Starting Coordinates: " << endl;
    // printCoordinates(start, 0 ,distanceEarthMiles(start, end));
    // cerr << "Ending Coordinates: " << endl;
    // printCoordinates(end, distanceEarthMiles(start, end), 0);
    // cerr << endl;
    // DEBUGGING
