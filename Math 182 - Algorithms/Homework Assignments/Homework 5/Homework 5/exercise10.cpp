...
// defined in auxFunctions.cpp; finds the continued fraction for root(n)
bool checkPerfectSquare(int N);
// defined in auxFunctions.cpp; checks whether N is a perfect square
...
cpp_int findMinimalSolution(int D) {
	...
	vector<int> continuedFraction = findContinuedFraction(D);
